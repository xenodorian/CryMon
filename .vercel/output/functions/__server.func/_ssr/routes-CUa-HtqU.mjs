...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CUa-HtqU.js
...
var TALK = {
	...
	forestEnter: [{
		...
		speaker: "none",
		text: "Tall grass. Patrols. If they see you, they will come. The path keeps south."
	}],
	forestLeave: [{
		speaker: "max",
	...
	groveEnter: [{
		speaker: "max",
		text: "The grass dies out. Stone and hush."
	}, {
		speaker: "none",
		text: "No tall grass. Something waits on the path."
	}],
	groveLeave: [{
		speaker: "max",
		text: "Back under the trees."
	}],
	cathleenSpot: [
		{
			speaker: "cathleen",
			text: "You walked the path. I am the path's answer."
		},
		{
			speaker: "max",
			text: "You're a CryMon."
		},
		{
			speaker: "cathleen",
			text: "I am Cathleen. I fight as myself."
		}
	],
	cathleenAfter: [{
		speaker: "cathleen",
		text: "You stand. Come again if you mean to keep me."
	}, {
		speaker: "max",
		text: "I might."
	}],
	cathleenGone: [{
		speaker: "max",
		text: "Only the hood's shadow. She's with me now."
	}],
	shinigamiSpot: [
		{
			speaker: "shinigami",
			text: "Three names. Three graves. I keep them."
		},
		{
			speaker: "max",
	...
	shinigamiAfter: [{
		speaker: "shinigami",
		text: "The mares return to fog. You may pass."
	}, {
		speaker: "max",
		text: "I will."
	}],
...
var Gemwar = class {
	...
	async loadArt() {
		const loaded = await Promise.all([
			...
			["fenwisp-1", "/sprites/monsters/fenwisp/1.png"],
			["fenwisp-2", "/sprites/monsters/fenwisp/2.png"],
			["fenwisp-3", "/sprites/monsters/fenwisp/3.png"],
			["fenwisp-4", "/sprites/monsters/fenwisp/4.png"],
			["duskhorn-1", "/sprites/monsters/duskhorn/1.png"],
			["duskhorn-2", "/sprites/monsters/duskhorn/2.png"],
			["duskhorn-3", "/sprites/monsters/duskhorn/3.png"],
			["duskhorn-4", "/sprites/monsters/duskhorn/4.png"],
			["needleroot-1", "/sprites/monsters/needleroot/1.png"],
			["needleroot-2", "/sprites/monsters/needleroot/2.png"],
			["needleroot-3", "/sprites/monsters/needleroot/3.png"],
			["needleroot-4", "/sprites/monsters/needleroot/4.png"],
			...
			["crymare-1", "/sprites/monsters/crymare/1.png"],
			["crymare-2", "/sprites/monsters/crymare/2.png"],
			["crymare-3", "/sprites/monsters/crymare/3.png"],
			["crymare-4", "/sprites/monsters/crymare/4.png"],
			...
			["port-fenwisp", "/sprites/portraits/fenwisp.png"],
			["port-duskhorn", "/sprites/portraits/duskhorn.png"],
			["port-needleroot", "/sprites/portraits/needleroot.png"],
			["port-cathleen", "/sprites/portraits/cathleen.png"],
			["port-shinigami", "/sprites/portraits/shinigami.png"],
			["port-crymare", "/sprites/portraits/crymare.png"],
	...
	advanceTalk() {
		...
		if (this.talkI >= this.talkQ.length) {
			...
			if (next === "shop") this.openShop();
				...
				if (!this.beatShinigami) this.startBattle(mintMonster("crymare", 5), false, "Shinigami sends CryMare", "shinigami", null, [mintMonster("crymare", 6), mintMonster("crymare", 7)]);
			}
			this.maybeStartAnne();
		}
	}
	...
	startBattle(foe, wild, title, trainer = wild ? "wild" : "calder", soldierId = null, bench = []) {
		...
		const foeName = wild ? foe.name : trainer === "mason" ? "Mason" : trainer === "soldier" ? soldierName : trainer === "shinigami" ? "Shinigami" : "Calder";
		this.battle = {
			wild,
			trainer,
			foeName,
	...
	attackMenu(p) {
		...
		if (s.spells?.length) return s.spells.map((sp) => sp.pp ? `${sp.name}  ${p.specialPp}/${p.specialPpMax}` : sp.name);
		return [
			`${s.basic}`,
	...
	updateBattle(dt) {
		...
		if (b.phase === "resolve_guard") {
			...
			if (foeS.spells?.length) {
				...
				if (this.selfDebuffed() && b.foe.specialPp > 0 && Math.random() < .55) spell = foeS.spells.find((sp) => sp.id === "manasurge") ?? spell;
				const result = this.castSpell(spell.id, false) ?? {
					dmg: 1,
					label: spell.name
				};
				base = result.dmg;
				...
				useSpecial ? b.foe.spc + b.mods.foeSpc : b.foe.str + b.mods.foeStr;
			...
			const chance = clamp(50 + ((g === "dodge" ? b.player.agl + b.mods.selfAgl : g === "block" ? b.player.str + b.mods.selfStr : b.player.spc + b.mods.selfSpc) - atkStat) * 5 + randI(-10, 10), 12, 88);
	...
	pickItem(i) {
		...
		if (id === "salve") {
			...
			if (!b.wild) {
				...
				if (randI(1, 100) <= chance && this.party.length < 6) {
					this.party.push({
						...b.foe,
	...
	drawTalk() {
		...
		if (beat.speaker !== "none") {
			...
			this.ctx.fillRect(X(108), 0, 640 - X(108), 480);
	...
	drawParty() {
		...
		if (this.partyView === "stats" || this.partyView === "moves") {
			...
			if (this.partyView === "stats") {
				...
				if (s.spells?.length) s.spells.forEach((sp, i) => {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RomFile, {
							href: "/rom/CryMon-ports.zip?v=cm1",
							filename: "CryMon-ports.zip",
							variant: "default",
							children: "Copy into Ports"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RomFile, {
							href: "/rom/CryMon-portmaster.zip?v=cm1",
							filename: "CryMon-portmaster.zip",
							children: "PortMaster autoinstall"
						})
					]
				})]
			})
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "The old zip had a game-list XML in it. Dumping the whole archive into ports can replace the Ports list. Deleting CryMon afterwards leaves that list empty, so the carousel hides Ports. The firmware is not bricked." }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
								...
								" ",
								"if they are there. Delete leftover GEMWAR.sh / gemwar and any older CryMon.sh / crymon folder."
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
								"Do not delete the ",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "font-display text-lg text-fg",
						children: "Install CryMon after that"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
						...
						". Unzip, then copy only CryMon.sh and the crymon folder into the existing ports folder. Do not replace the folder. Do not copy any XML."
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
							...
							rel: "noopener",
							children: "CryMon-ports.zip"
						}),
						" — ",
						"launcher plus game folder only. Aarch64 binary for the R36S, plus x86_64 for a PC."
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
						"Or drop",
						" ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
							...
							rel: "noopener",
							children: "CryMon-portmaster.zip"
						}),
						" ",
						"into PortMaster's autoinstall folder and let it copy those two items."
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "font-display text-lg text-fg",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Copy into Ports is only CryMon.sh and the crymon folder. This screen is the same 640×480 game."
					})
				]
			})]
		})]
