...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BUEj5Gp1.js
var router_BUEj5Gp1_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BC-pfSvZ.css";
var APP_NAME = "GEMWAR";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "GEMWAR — Max runs with stolen Capture Crystals into a CryMon war. Original GBA homebrew."
			},
			{
				name: "theme-color",
				content: "#12110e"
...
var $$splitComponentImporter = () => import("./routes-BlcnZOll.mjs");
...
//#endregion
export { getRouter, router_BUEj5Gp1_exports as t };
