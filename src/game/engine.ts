...
export class Gemwar {
	...
	async loadArt() {
		const loaded = await Promise.all([
			...
			["mason-down-1", "/sprites/mason/down-1.png?v=ow7"],
			["mason-down-2", "/sprites/mason/down-2.png?v=ow7"],
			["mason-down-3", "/sprites/mason/down-3.png?v=ow7"],
			["mason-down-4", "/sprites/mason/down-4.png?v=ow7"],
			["mason-left-1", "/sprites/mason/left-1.png?v=ow7"],
			["mason-left-2", "/sprites/mason/left-2.png?v=ow7"],
			["mason-left-3", "/sprites/mason/left-3.png?v=ow7"],
			["mason-left-4", "/sprites/mason/left-4.png?v=ow7"],
			["mason-right-1", "/sprites/mason/right-1.png?v=ow7"],
			["mason-right-2", "/sprites/mason/right-2.png?v=ow7"],
			["mason-right-3", "/sprites/mason/right-3.png?v=ow7"],
			["mason-right-4", "/sprites/mason/right-4.png?v=ow7"],
			["mason-up-1", "/sprites/mason/up-1.png?v=ow7"],
			["mason-up-2", "/sprites/mason/up-2.png?v=ow7"],
			["mason-up-3", "/sprites/mason/up-3.png?v=ow7"],
			["mason-up-4", "/sprites/mason/up-4.png?v=ow7"],
